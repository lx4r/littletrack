					...
					<div className="flex items-center gap-3">
						...
						{completeTimeEntries.length > 0 && (
							<details ref={detailsRef} className="relative">
								<summary className="flex items-center justify-center rounded-full bg-neutral-600 p-1 text-neutral-200 hover:bg-neutral-700 hover:text-neutral-100 cursor-pointer list-none [&::-webkit-details-marker]:hidden [&::marker]:hidden focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-1">
								...
								<div className="absolute right-0 top-8 z-10 w-48 rounded-md bg-neutral-700 shadow-lg ring-1 ring-black ring-opacity-5">
									<div className="py-1">
										<button
											type="button"
											onClick={handleKebabBatchDeleteClick}

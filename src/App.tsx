...
const App = ({
	...
	const toggleIsoDateSelection = (isoDate: string) => {
									...
									{isBatchDeleteModeEnabled && (
										<label className="mr-3 flex items-center">
											<input
												type="checkbox"
												checked={isSelected}
												onChange={() => toggleIsoDateSelection(isoDate)}
												className="h-5 w-5 rounded border-neutral-400 bg-neutral-800 text-red-600 focus:ring-red-500"
											/>
										</label>
									)}
